...
function FrameManager:CreateClickerFrame(unitButton)
	...
	Utils:Debug("Attempting to create texture frame - textureEnabled: " .. tostring(settings.textureEnabled) .. ", selectedTexture: " .. tostring(settings.selectedTexture))
	local textureFrame = self.textureManager:CreateTextureFrame(
		hitbox, 
