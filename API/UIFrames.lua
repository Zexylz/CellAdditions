...
function UIFrames:CreateToggle(parent, text, callback, tooltips)
  ...
  -- Button methods
  function toggle:SetChecked(checked) toggle.button:SetChecked(checked) end

  function toggle:GetChecked() return toggle.button:GetChecked() end

  function toggle:SetEnabled(enabled) Cell.SetEnabled(enabled, toggle.button, toggle.label) end
